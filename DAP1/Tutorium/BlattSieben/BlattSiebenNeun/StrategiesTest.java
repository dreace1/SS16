public class StrategiesTest
{
    ...
    public static void testStrategy()
    {
        ...
        System.out.println("Es kommen " + int05.getCount() + " Elemente aus dem Intervall 0-5 in ints vor");
        System.out.println();
        ...
        System.out.println("Der Durchschnitt der positiven Elemente von ints beträgt: " + avrg.getAverage());
        System.out.println();
        ...
        System.out.println("Alle Elemente von ints2 auf den abslolut Wert gesetzt");
        ints2.showAll();
        System.out.println();
        ...
        System.out.println("Alle Elemente aus dem Intervall 0-5 verdoppelt: ");
        ints4.showAll();
        System.out.println();
        ...
        System.out.println("Das 1. und jedes 3. Elemente von ints8 gelöscht: ");
        ints8.showAll();
        System.out.println();
        ...
        ints9.add( 10 );
        ints9.showAll();
        TestatSumOfSecondStrategy sum = new TestatSumOfSecondStrategy();
        ints9.inspectAll(sum);
        System.out.println("Die Summe jedes 2. Elements: " + sum.getSum());
        System.out.println();
