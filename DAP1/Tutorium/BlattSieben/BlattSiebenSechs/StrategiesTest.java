public class StrategiesTest
{
    ...
    public static void testStrategy()
    {
        ...
        System.out.println("Es kommen " + int05.getCount() + " Elemente aus dem Interval 0-5 in ints vor");
        System.out.println();
        ...
        System.out.println("Durschnitt der positiven Elemente von ints: " + avrg.getAverage());
        System.out.println();
        ...
        System.out.println("Alle Elemente aus dem Interval 0-5 von ints4 verdoppelt: ");
        ints4.showAll();
        System.out.println();
        ...
        System.out.println("Alle negativen Elemnte von ints5 gelöscht: ");
        ints5.showAll();
        System.out.println();
        ...
        System.out.println("Alle Elemnte von ints6 aus dem Intevall 0-5 gelöscht ");
        ints6.showAll();
        System.out.println();
        ...
        System.out.println("Alle Elemnte von ints7 aus dem Intevall 0-5 gelöscht ");
        ints7.showAll();
        System.out.println("Anzahl der gelöschten Elemnte: " + rem05Ac.getCount());
        System.out.println();
