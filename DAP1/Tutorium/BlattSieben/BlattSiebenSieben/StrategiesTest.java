public class StrategiesTest
{
    ...
    public static void testStrategy()
    {
        ...
        System.out.println("Es kommen " + int05.getCount() + " Elemente aus dem Intevall 0-5 vor");
        System.out.println();
        ...
        System.out.println("Alle Elemente von ints2 auf den absolut Wert: ");
        ints2.showAll();
        System.out.println();
        ...
        System.out.println("Alle Elemente aus dem Interval 0-5 verdoppelt");
        ints4.showAll();
        System.out.println();
        ...
        System.out.println("Alle Elemente aus dem Intervall 0-5 gelöscht");
        ints6.showAll();
        System.out.println();
