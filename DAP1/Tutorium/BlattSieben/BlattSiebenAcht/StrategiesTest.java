public class StrategiesTest
{
    ...
    public static void testStrategy()
    {
        ...
        System.out.println("Es kommen " + int05.getCount() + " Elemente vor, die in dem Intervall 0-5 liegen");
        System.out.println();
        ...
        System.out.println("Der Durschnitt der positiven Elemente von ints beträgt: " + avrg.getAverage());
        System.out.println();
        ...
        System.out.println("Alle Elemente aus dem Intevall 0-5 verdoppelt: ");
        ints4.showAll();
        System.out.println();
        ...
        System.out.println("Alle Elemente aus dem Intevall 0-5 von ints6 gelöscht: ");
        ints6.showAll();
        System.out.println();
        ...
        System.out.println("Alle Elemente aus dem Intevall 0-5 von ints7 gelöscht: ");
        ints7.showAll();
