public class Testumgebung
{
    public static void main( String[] args )
    {
        ...
        //Aufgabe 1b
        testPairs.show();
        System.out.println("Anzahl der geraden keys Werte: " + testPairs.accumulate((k,v) -> {if (k%2 == 0) {return 1;} else {return 0;}}));
        System.out.println();
        //Aufgabe 1f
        testPairs.show();
        System.out.println("Anzahl der Werte deren values Wert größer als 10 ist:  " + testPairs.accumulate((k,v) -> {if (v>10) {return 1;} else {return 0;}}));
        System.out.println();
        //Aufgabe 1l
        testPairs.show();
        ...
        //Aufgabe 1c
        testPairs.show();
        System.out.println("Löschen aller Paare mit den keys Wert 6: ");
        testPairs.remove((k,v) -> k == 6);
        testPairs.show();
        System.out.println();
        //Aufgabe 1h
        testPairs.show();
        System.out.println("Löschen aller Paare mit negativen Wert in values: ");
        testPairs.remove((k,v) -> v<0);
        testPairs.show();
        System.out.println();
        //Aufgabe 1k
        testPairs.show();
        System.out.println("Löschen aller Paare mit identischen Werten: ");
        testPairs.remove((k,v) -> k == v);
        testPairs.show();
        System.out.println();
        //Aufgabe 1d
        testPairs.show();
        System.out.println("Jeder keys Wert um 10 erhöht: ");
        testPairs.manipulate((k,v) -> k+10, (k,v) -> v);
        testPairs.show();
        System.out.println();
        //Aufgabe 1g
        testPairs.show();
        System.out.println("Jeder keys Wert um 5 erhöht wenn values größer als 3 ist: ");
        testPairs.manipulate((k,v) -> {if (v>3) {return k+5;} else {return k;}}, (k,v) -> v);
        testPairs.show();
        System.out.println();
        //Aufgabe 1i
        testPairs.show();
        System.out.println("Jeder Wert in values verdoppelt: ");
