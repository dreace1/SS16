public class Testumgebung
{
    public static void main( String[] args )
    {
        ...
        //Aufgabe 1f
        testPairs.show();
        System.out.println("Anzahl von value größer 10: " + testPairs.accumulate((k,v) -> {if (v>10) {return 1;} else {return 0;}}));
        System.out.println();
        //Aufgabe 1l
        testPairs.show();
        ...
        //Aufgabe 1c
        testPairs.show();
        System.out.println("Löschen von Paaren mit dem key Wert 6: ");
        ...
        //Aufgabe 1k
        testPairs.show();
        System.out.println("Löschen von Paaren mit identischen keys und values Wert: ");
        testPairs.remove((k,v) -> k == v);
        testPairs.show();
        System.out.println();
        //Aufgabe 1d
        testPairs.show();
        System.out.println("Jeden keys Wert + 10: ");
        testPairs.manipulate((k,v) -> k+10, (k,v) -> v);
        testPairs.show();
        System.out.println();
        //Aufgabe 1g
        testPairs.show();
        System.out.println("keys + 5 wenn values größer als 3 ist: ");
        testPairs.manipulate((k,v) -> {if (v>3) {return k+3;} else {return k;}}, (k,v) -> v);
        testPairs.show();
        System.out.println();
        //Aufgabe 1i
        testPairs.show();
