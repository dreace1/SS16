public class Testumgebung
{
    public static void main( String[] args )
    {
        ...
        System.out.print("extract values >15: "); otherPairs = testPairs.extract( (k,v) -> v>15 ); otherPairs.show(); System.out.println();
    ...
    {
        IntIntPairs all = new IntIntPairs( first.accumulate( (k,v) -> 1 ) + first.accumulate( (k,v) -> 1 ) );
        all.combine( first );
        all.combine( second );
        return all;
    }
