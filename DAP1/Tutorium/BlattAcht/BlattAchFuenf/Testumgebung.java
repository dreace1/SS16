public class Testumgebung
{
    public static void main( String[] args )
    {
        ...
        //Aufgabe 1b
        testPairs.show();
        System.out.println("Anzahl der geraden Werte in keys: " + testPairs.accumulate((k,v) -> {if (k%2==0) {return 1;} else {return 0;}}));
        System.out.println();
        //Aufgabe 1f
        testPairs.show();
        System.out.println("Anzahl der Paare mit values größer 10: " + testPairs.accumulate((k,v) -> {if (v>10) {return 1;} else {return 0;}}));
        System.out.println();
        //Aufgabe 1l
        testPairs.show();
        ...
        //Aufgabe 1c
        testPairs.show();
        System.out.println("Löschen aller Paare deren keys Wert gleich 6 ist: ");
        ...
        //Aufgabe 1k
        testPairs.show();
        System.out.println("Löschen aller Paare mit gleichen keys und values Wert: ");
        ...
        //Aufgabe 1g
        testPairs.show();
        System.out.println("keys Werte um 5 erhöht wenn values Wert größer als 3 ist: ");
        testPairs.manipulate((k,v) -> {if (v>3) {return k+5;} else {return k;}}, (k,v) -> v);
        testPairs.show();
        System.out.println();
        //Aufgabe 1i
        testPairs.show();
        System.out.println("Alle Werte in values verdoppelt: ");
