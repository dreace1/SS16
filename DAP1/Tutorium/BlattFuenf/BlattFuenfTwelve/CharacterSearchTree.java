public class CharacterSearchTree
{
    ...
    public int countTestatTwice()
    {
      ...
      else
      {
        if(isLeaf())
        {
          return content.getQuantity() + leftChild.countTestatTwice() + rightChild.countTestatTwice();
        }
        else
        {
          return leftChild.countTestatTwice() + rightChild.countTestatTwice();
        }
      }
    }
